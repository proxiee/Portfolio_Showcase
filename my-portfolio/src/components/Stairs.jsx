    ...
    return (
        [...Array(6)].map((_, index) => (
            <motion.div
                ...
                className="h-full w-full relative overflow-hidden bg-light-text-primary/30 dark:bg-black/50 backdrop-blur-md border-r border-light-bg/20 dark:border-dark-bg/20"
            >
