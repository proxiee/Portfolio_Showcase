...
const ResumePage = () => (
    ...
    >
        ...
        <div className="relative bg-white/5 dark:bg-black/20 backdrop-blur-md border border-black/10 dark:border-white/10 rounded-2xl shadow-2xl overflow-hidden p-8 transition-colors duration-1000">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300 transition-colors duration-1000">MS in Computer Science Graduate </p>
                </div>
                <a 
                    href="/resume.pdf" // This should point to your resume file in the /public folder
                    download 
                    className="flex items-center justify-center gap-2 w-full md:w-auto px-6 py-3 font-semibold text-black dark:text-white bg-black/5 dark:bg-white/10 border-2 border-black/10 dark:border-white/20 rounded-lg hover:bg-black/10 dark:hover:bg-white/20 transition-all duration-500"
                >
                    Download PDF
                </a>
            </div>
            ...
            {/* Experience Section */}
            <div className="mb-8">
                <h4 className="text-2xl font-bold border-b border-black/10 dark:border-white/20 pb-2 mb-4 transition-colors duration-1000">Experience</h4>
                <div className="mb-6">
                    <h5 className="text-xl font-semibold">Software Developer - Cognizant Technology Solutions </h5>
                    <p className="text-gray-500 dark:text-gray-400 mb-2 transition-colors duration-1000">March 2023 - Aug 2023 </p>
                    <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-1 transition-colors duration-1000">
                ...
                <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mb-2 transition-colors duration-1000">March 2022 - Sept 2022 </p>
                    <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-1 transition-colors duration-1000">
            ...
            {/* Projects Section */}
            <div className="mb-8">
                <h4 className="text-2xl font-bold border-b border-black/10 dark:border-white/20 pb-2 mb-4 transition-colors duration-1000">Projects</h4>
                <div className="mb-6">
            ...
            {/* Education Section */}
            <div className="mb-8">
                <h4 className="text-2xl font-bold border-b border-black/10 dark:border-white/20 pb-2 mb-4 transition-colors duration-1000">Education</h4>
                <div className="mb-6">
                    <h5 className="text-xl font-semibold">M.S. in Computer Science - University of Dayton </h5>
                    <p className="text-gray-500 dark:text-gray-400 mb-2 transition-colors duration-1000">Aug 2023 - May 2025 </p>
                </div>
                <div>
                    <h5 className="text-xl font-semibold">B.Tech. in Computer Science & Engineering - Jawaharlal Nehru Technological University </h5>
                    <p className="text-gray-500 dark:text-gray-400 mb-2 transition-colors duration-1000">June 2018 - July 2022 </p>
                </div>
            </div>

            {/* Skills Section */}
            <div>
                <h4 className="text-2xl font-bold border-b border-black/10 dark:border-white/20 pb-2 mb-4 transition-colors duration-1000">Skills</h4>
                <div className="text-gray-600 dark:text-gray-300 transition-colors duration-1000">
                    <p className="mb-2"><strong className="font-semibold text-black dark:text-white">Core:</strong> Java, Python, Distributed Systems, Microservices, ML Model Serving (LLMs), Performance Tuning, AWS, GCP </p>
                    <p><strong className="font-semibold text-black dark:text-white">Key Tech:</strong> Azure (App Service, Functions, Cosmos DB), AWS, GCP, Docker, Kubernetes, CI/CD (Jenkins, Azure Pipelines), Git </p>
                </div>
            </div>
